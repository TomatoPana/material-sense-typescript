...
class Main extends Component<MainProps, MainState> {
    ...
    onLearnMoreDialogOpen = (event: SyntheticEvent) => {
        this.setState({
            learnMoreDialog: true,
        });
    }

    onLearnMoreDialogClose = (event: SyntheticEvent) => {
        this.setState({
            learnMoreDialog: false,
        });
    }

    onGetStartedDialogOpen = (event: SyntheticEvent) => {
        this.setState({
            getStartedDialog: true,
        });
    }

    onGetStartedDialogClose = (event: SyntheticEvent) => {
        this.setState({
            getStartedDialog: false,
        });
    }
        ...
        return (
            <Fragment>
                        ...
                        <Grid item xs={12} md={4}>
                            <Paper className={classes.paper}>
                                ...
                                <div className={classes.alignRight}>
                                    <Button onClick={this.onLearnMoreDialogOpen}  variant="outlined" className={classes.actionButtom}>
                                        Learn more
                                    </Button>
                                    <Button onClick={this.onGetStartedDialogOpen} color='primary' variant="contained" className={classes.actionButtom}>
                                        Dashboard
                                    </Button>
                                </div>
                            </Paper>
                ...
                <SwipeDialog
                    ...
                    onClose={this.onLearnMoreDialogClose} 
                />
                <InstructionDialog
                    open={this.state.getStartedDialog}
                    onClose={this.onGetStartedDialogClose}
                />
                </div>
            </Fragment>
        );
